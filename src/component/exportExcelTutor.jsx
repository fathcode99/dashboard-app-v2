...
const ExcelExportTutor = ({ data }) => {
    const createDownLoadData = () => {
        handleExport().then((url) => {
            const downloadAnchorNode = document.createElement("a");
            downloadAnchorNode.setAttribute("href", url);
            downloadAnchorNode.setAttribute("download", "data_pengajar.xlsx");
    ...
    const handleExport = () => {
        ...
        XLSX.utils.book_append_sheet(wb, sheet, "data_pengajar");
...
export default ExcelExportTutor;