...
const ExcelExportTotalBy = ({ data }) => {
    const createDownLoadData = () => {
        handleExport().then((url) => {
            const downloadAnchorNode = document.createElement("a");
            downloadAnchorNode.setAttribute("href", url);
            downloadAnchorNode.setAttribute("download", "data_total_biaya.xlsx");
    ...
    const handleExport = () => {
        const title = [{ A: "DATA TOTAL BIAYA" }, {}];
        ...
        XLSX.utils.book_append_sheet(wb, sheet, "data_total_biaya");
...
export default ExcelExportTotalBy;