...
const Sidebar = () => {
  ...
  return (
    // <div className="min-w-[40px] lg:w-fit flex flex-col  min-h-screen drop-shadow-[2px_2px_2px_rgba(0,0,0,0.5)]">
      <div className="min-w-[40px] flex flex-col lg:min-w-[200px] h-full text-white justify-center bg-ungutua ">
        
        <div className="w-full items-center sidebar  flex text-sm flex-col gap-6 md:gap-3 lg:gap-0">
